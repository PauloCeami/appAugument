...
/**
 * Sanitiza um número de WhatsApp removendo todos os caracteres não numéricos
 * @param whatsapp - Número do WhatsApp com ou sem formatação
 * @returns Número sanitizado contendo apenas dígitos
 */
