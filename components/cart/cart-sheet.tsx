...
export function CartSheet() {
  ...
  const handleConfirmOrder = (customerName: string, customerAddress: string, customerNotes: string) => {
    const whatsappLink = buildWhatsAppLink(customerName, customerAddress, customerNotes);
